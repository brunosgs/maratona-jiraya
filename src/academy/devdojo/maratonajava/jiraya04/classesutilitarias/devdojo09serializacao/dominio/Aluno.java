...
// Não existe a chamada para objetos que são Serializable
public class Aluno implements Serializable {
	private static final long serialVersionUID = -3038869728890695362L;
	private Long id;
	private String nome;
	// Quando é informado o transient, significa que o atributo não deve ser
	// Serializado.
	private transient String password;
	// Atributos static não são serializados, eles pertencem ao objeto.
